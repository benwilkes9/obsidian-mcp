...
**Dashboard:** View detailed metrics and trends in the SonarCloud dashboard for this project.
...
- **Issues**: Open issues in the GitHub Issues tab
- **Discussions**: Ask questions in GitHub Discussions
- **MCP Documentation**: Refer to the Model Context Protocol documentation
